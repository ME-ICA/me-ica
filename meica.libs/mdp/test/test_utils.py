...
def test_introspection():
    ...
    assert sorted(arrays.keys()) == ['x', 'y.x', 'z.x', 'z.z.x'], 'Wrong names'
    ...
    keys = [
        '_cov_mtx._avg', '_cov_mtx._cov_mtx', '_dcov_mtx._avg',
        '_dcov_mtx._cov_mtx'
    ]
...
def test_QuadraticForm_non_symmetric_raises():
    ...
    py.test.raises(mdp.utils.QuadraticFormException, utils.QuadraticForm, H)


def test_nongeneral_svd_bug():
    a = numx.array([[0.73083003, 0., 0.7641788, 0.], [0., 0., 0., 0.],
                    [0.7641788, 0., 0.79904932, 0.], [0., 0., 0., 0.]])
