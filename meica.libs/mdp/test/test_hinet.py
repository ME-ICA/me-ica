...
_get_new_flow = lambda: mdp.Flow([mdp.nodes.NoiseNode(), mdp.nodes.SFANode()])
...
NODES = [
    (mh.FlowNode, [_get_new_flow], None),
...
def _pca_nodes(input_dims, output_dims):
    return [
        mdp.nodes.PCANode(input_dim=ind, output_dim=outd)
...
def test_SwitchboardInverse1():
    sboard = mh.Switchboard(input_dim=3, connections=[2, 0, 1])
...
def testSwitchboardInverse2():
    sboard = mh.Switchboard(input_dim=3, connections=[2, 1, 1])
...
def test_MeanInverseSwitchboard2():
    sboard = mh.MeanInverseSwitchboard(
        input_dim=3, connections=[1, 1, 1, 2, 2])
    assert sboard.is_invertible()
...
def test_Rect_double_routing_1():
    sboard = mh.DoubleRect2dSwitchboard(
        in_channels_xy=4, field_channels_xy=2, in_channel_dim=1)
    assert (sboard.connections == numx.array([
        0,
        1,
        4,
...
def test_Rect_double_routing_2():
    sboard = mh.DoubleRect2dSwitchboard(
        in_channels_xy=(6, 4), field_channels_xy=(2, 2), in_channel_dim=1)
    assert (sboard.connections == numx.array([
        0,
        1,
        6,
...
def test_Rect_double_routing_3():
    sboard = mh.DoubleRect2dSwitchboard(
        in_channels_xy=(4, 6), field_channels_xy=2, in_channel_dim=1)
    assert (sboard.connections == numx.array([
        0,
        1,
        4,
...
def test_DoubleRhomb_routing_1():
    sboard = mh.DoubleRhomb2dSwitchboard(
        long_in_channels_xy=(3, 2), diag_field_channels=2, in_channel_dim=1)
...
def test_DoubleRhomd_routing_2():
    sboard = mh.DoubleRhomb2dSwitchboard(
        long_in_channels_xy=(2, 3), diag_field_channels=2, in_channel_dim=1)
    assert (sboard.connections == numx.array([6, 2, 3, 7])).all()
    x = numx.array([
        list(range(0, sboard.input_dim)),
        list(range(101, 101 + sboard.input_dim))
    ])
...
def test_DoubleRhomd_routing_3():
    sboard = mh.DoubleRhomb2dSwitchboard(
        long_in_channels_xy=(4, 2), diag_field_channels=2, in_channel_dim=1)
...
def test_DoubleRhomd_routing_4():
    sboard = mh.DoubleRhomb2dSwitchboard(
        long_in_channels_xy=(2, 4), diag_field_channels=2, in_channel_dim=1)
...
def test_DoubleRhomd_routing_5():
    sboard = mh.DoubleRhomb2dSwitchboard(
        long_in_channels_xy=4, diag_field_channels=2, in_channel_dim=1)
    assert (sboard.connections == numx.array([
...
def test_DoubleRhomd_routing_6():
    sboard = mh.DoubleRhomb2dSwitchboard(
        long_in_channels_xy=(7, 4), diag_field_channels=4, in_channel_dim=1)
    x = numx.array([
        list(range(0, sboard.input_dim)),
        list(range(101, 101 + sboard.input_dim))
    ])
...
def test_DoubleRhomd_routing_7():
    sboard = mh.DoubleRhomb2dSwitchboard(
        long_in_channels_xy=(4, 7), diag_field_channels=4, in_channel_dim=1)
    x = numx.array([
        list(range(0, sboard.input_dim)),
        list(range(101, 101 + sboard.input_dim))
    ])
...
def test_DoubleRhomd_routing_8():
    sboard = mh.DoubleRhomb2dSwitchboard(
        long_in_channels_xy=(6, 7), diag_field_channels=4, in_channel_dim=1)
    x = numx.array([
        list(range(0, sboard.input_dim)),
        list(range(101, 101 + sboard.input_dim))
    ])
...
def test_hinet_simple_net():
    switchboard = mh.Rectangular2dSwitchboard(
        in_channels_xy=(12, 8),
        field_channels_xy=4,
        field_spacing_xy=2,
        in_channel_dim=3)
