...
def selcomps(seldict,debug=False,olevel=2,oversion=99,knobargs='',filecsdata=False,savecsdiag=True,group0_only=False,strict_mode=False, _Kappas=None, _Rhos=None):
    ...
    for key in list(seldict.keys()): exec("%s=seldict['%s']" % (key,key), globals())
