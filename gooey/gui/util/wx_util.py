...
def make_bold(statictext):
    ...
    font = wx.Font(pointsize, wx.FONTFAMILY_DEFAULT, wx.FONTWEIGHT_NORMAL,
...
def h0(parent, label):
    ...
    font = wx.Font(font_size * 1.4,
                   *(wx.FONTFAMILY_DEFAULT, wx.FONTWEIGHT_NORMAL,
                     wx.FONTWEIGHT_BOLD, False))
    text.SetFont(font)
    return text
...
def h1(parent, label):
    return _header(parent, label, (wx.FONTFAMILY_DEFAULT, wx.FONTWEIGHT_NORMAL,
                                   wx.FONTWEIGHT_BOLD, False))
